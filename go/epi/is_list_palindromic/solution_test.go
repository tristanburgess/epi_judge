package is_list_palindromic_test
...
import (
	...
	. "go-epi-judge/epi/is_list_palindromic"
	utils "go-epi-judge/test_utils"
)

type solutionFunc = func(*list.Node) bool
...
func TestIsLinkedListAPalindrome(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/is_list_palindromic.tsv")
