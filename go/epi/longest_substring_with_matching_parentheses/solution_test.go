...
import (
	...
	. "go-epi-judge/epi/longest_substring_with_matching_parentheses"
...
func TestLongestMatchingParentheses(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/longest_substring_with_matching_parentheses.tsv")
