...
import (
	...
	. "go-epi-judge/epi/minimum_weight_path_in_a_triangle"
...
func TestMinimumPathTotal(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/minimum_weight_path_in_a_triangle.tsv")
