...
import (
	...
	. "go-epi-judge/epi/huffman_coding"
	utils "go-epi-judge/test_utils"
)

type solutionFunc = func([]CharWithFrequency) float64
...
func TestHuffmanEncoding(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/huffman_coding.tsv")
