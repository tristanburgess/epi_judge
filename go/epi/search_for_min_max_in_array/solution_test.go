package search_for_min_max_in_array_test
...
import (
	...
	. "go-epi-judge/epi/search_for_min_max_in_array"
...
func TestFindMinMax(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/search_for_min_max_in_array.tsv")
