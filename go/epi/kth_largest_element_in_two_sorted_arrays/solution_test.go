...
import (
	...
	. "go-epi-judge/epi/kth_largest_element_in_two_sorted_arrays"
...
func TestFindKthNTwoSortedArrays(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/kth_largest_element_in_two_sorted_arrays.tsv")
