package element_appearing_once_test
...
import (
	...
	. "go-epi-judge/epi/element_appearing_once"
...
func TestFindElementAppearsOnce(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/element_appearing_once.tsv")
