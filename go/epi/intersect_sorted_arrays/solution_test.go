package intersect_sorted_arrays_test
...
import (
	...
	. "go-epi-judge/epi/intersect_sorted_arrays"
...
func TestIntersectTwoSortedArrays(t *testing.T) {
	testFileName := filepath.Join(cfg.TestDataFolder, "epi/intersect_sorted_arrays.tsv")
